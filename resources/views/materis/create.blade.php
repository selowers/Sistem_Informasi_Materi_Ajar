    ...
    <form action="{{ route('materis.store') }}" method="POST">
      ...
      <div class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <input type="text" name="file_materi" class="form-control" value="{{ old('file_materi') }}" required>
        </div>
        <div class="col-md-6">
          <label class="form-label">Tipe File</label>
          <input type="text" name="tipe_file" class="form-control" value="{{ old('tipe_file') }}">
        </div>
        <div class="col-md-6">
