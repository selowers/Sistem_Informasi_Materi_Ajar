...
@section('content')
  <div class="page-heading">
    <div class="page-heading-copy">
      ...
      <div>
        <p class="eyebrow mb-1">Tambah Kurikulum</p>
        <h1 class="h3 mb-1">Form Tambah Kurikulum</h1>
        <p class="text-muted mb-0">Tambahkan kurikulum baru untuk kelas dan mata pelajaran tertentu.</p>
      </div>
    </div>
  </div>
